...
protocol FeedCodeTableViewCellDelegate: AnyObject {
    func revealPostText(for cell: UITableViewCell)
}

class FeedCodeTableViewCell: UITableViewCell {
    
    static let reuseId = "FeedCell"
    weak var delegate: FeedCodeTableViewCellDelegate?
    ...
    let likesImage: UIImageView = {
       let imageView = UIImageView()
        ...
        imageView.tintColor = #colorLiteral(red: 0.5768421292, green: 0.6187390685, blue: 0.664434731, alpha: 1)
        return imageView
    }()
    ...
    @objc
    func showMoreText() {
        delegate?.revealPostText(for: self)
    }
    ...
    private func overlayFourthLayerOnBottomViewViews() {
        ...
        createConstraintsInFourthLayer(view: likesView, imageView: likesImage, label: likesLabel)
        createConstraintsInFourthLayer(view: commentsView, imageView: commentsImage, label: commentsLabel)
        createConstraintsInFourthLayer(view: sharesView, imageView: sharesImage, label: sharesLabel)
        createConstraintsInFourthLayer(view: viewsView, imageView: viewsImage, label: viewsLabel)
    }
    
    private func createConstraintsInFourthLayer(view: UIView, imageView: UIImageView, label: UILabel) {
